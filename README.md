...
- **Optional modules** — Receipt scanner, calendar, analytics, AI assistant (when enabled)
...
**Nvalope**, **The Canny Coyote**, **Cache**, and related names and logos are reserved to The Canny Coyote and contributors. The code is MIT-licensed; the license does not grant use of these names, marks, or branding for derivative works or your own products without permission. See in-app Terms of Use for the full trademark section.
