...
export function MainContent({
  ...
  const renderSectionContentCard = (sectionData: AppSection) => (
    ...
    >
      <Card
        className="bg-card border-primary/30 shadow-xl relative w-full min-w-0 overflow-x-auto border-l-4"
        style={{ borderLeftColor: sectionData.color ?? 'var(--primary)' }}
      >
        <div className="p-4 sm:p-6 min-w-0">
          <div className="flex items-start justify-between mb-4">
            <div className="flex-1">
              <h2 className="text-xl font-semibold text-primary mb-1">{sectionData.title}</h2>
          ...
          <div className="border-t border-border pt-4">{sectionData.content}</div>
        </div>
      </Card>
    </motion.div>
  );
  ...
  return (
    <>
      ...
      >
        <div
          className="origin-top w-full max-w-full min-w-0"
          style={{
        ...
        >
          ...
          <div className="max-w-[42rem] w-full mx-auto min-w-0 flex flex-col items-stretch px-0">
          <motion.div
          ...
          >
            <div className="w-full min-w-0 flex flex-col items-stretch">
              ...
              <Card className="glass-card relative overflow-hidden w-full">
          ...
          <div className="mt-4 w-full flex flex-col items-center gap-4">
            {selectedMode === 'focus' ? (
              ...
              <div key="cards" data-layout="cards" className="contents">
              ...
              <div key="wheel" data-layout="wheel" className="contents">
                {wheelMinimized ? (
                  ...
                  <>
                    <div className="relative w-full flex justify-center">
                      ...
                      <div className="flex justify-center flex-1 min-w-0">
                        <div
                          className="block origin-top overflow-visible relative z-10"
                          style={{
                            width: `${600 * (clampWheelScale(wheelScale) / 100)}px`,
                            height: `${410 * (clampWheelScale(wheelScale) / 100)}px`,
                          }}
                        >
                          <div
                            style={{
                              width: 600,
                              height: 600,
                              transform: `translateY(-80px) scale(${clampWheelScale(wheelScale) / 100})`,
          ...
          <div className="w-full mt-8 focus-mode-hide space-y-4">
            <Dialog open={aboutOpen} onOpenChange={setAboutOpen}>
              <DialogContent className="max-w-[min(32rem,100%)] max-h-[85vh] flex flex-col p-0 gap-0" aria-describedby={undefined}>
                <DialogHeader className="px-6 pt-6 pb-2 shrink-0">
                  <DialogTitle id="about-dialog-title">About The Canny Coyote</DialogTitle>
                </DialogHeader>
            ...
            <div className="space-y-4">
              ...
              <p className="text-xs text-muted-foreground text-center leading-relaxed">
                ...
                Cache the AI Assistant™ are trademarks of The Canny Coyote™ 🐺
              </p>
            </div>
            <footer className="flex flex-wrap items-center justify-center gap-x-2 gap-y-1 text-xs text-muted-foreground focus-mode-hide" role="contentinfo" aria-label="Footer links">
              <button
                ...
                className="footer-link-btn bg-transparent border-0 p-0 m-0 font-inherit text-primary hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 cursor-pointer inline"
                aria-label="About The Canny Coyote"
              >
                About
              </button>
