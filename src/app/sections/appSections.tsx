      ...
      ? [
          {
            ...
            description: `Smart insights and budgeting help. Ask about spending, envelopes, or how to add expenses. ${CACHE_MODULE_LOCAL_AI_HINT}`,
            color: '#2d7a3f',
            content: (
      ...
      ? [
          {
            ...
            description: `Predictive insights and smarter suggestions. ${CACHE_MODULE_LOCAL_AI_HINT}`,
            color: '#2d7a3f',
            content: (
              <div className="space-y-4">
