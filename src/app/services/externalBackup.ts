...
/** Same structure we write to folder (version 2: budget, settings, premium, appData). */
...
export async function downloadFullBackup(
  ...
  const payload = buildBackupPayload(snapshot, hasFolder);
