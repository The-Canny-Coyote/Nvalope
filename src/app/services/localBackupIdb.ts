/**
 * Local autobackup storage in IndexedDB. Used when the File System Access API
 * is unavailable (e.g. Firefox, Safari) or when the user has not chosen a backup folder.
 * One backup snapshot is kept on this device and overwritten every time autobackup runs.
