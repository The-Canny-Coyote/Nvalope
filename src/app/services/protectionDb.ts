/**
 * Minimal IndexedDB for protection-related data (e.g. external backup folder handle).
 * Used by externalBackup so we don't need the full storageProtection stack.
 */
