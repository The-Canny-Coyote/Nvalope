/**
 * Regex-based receipt category suggestion: vendor/keyword patterns → category label.
 * Used when WebLLM is not available or as fallback. All patterns are case-insensitive.
 */
