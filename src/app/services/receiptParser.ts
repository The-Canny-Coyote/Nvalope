/**
 * Receipt text parser: extract total, merchant, and line items from OCR text.
 * Designed to be simple, robust, and effective across common receipt formats.
 * Handles messy OCR: flexible decimals, price-at-start or price-at-end, normalized whitespace.
 * Extended: date, time, currency, subtotal, tax, refund/change, quantity; optional glossary.
 */
